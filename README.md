...
_Figure 2: Accessing CubeMX Board Selector Tool._
...
_Figure 5: CubeMX Debug Setup._
...
_Figure 7: CubeMX Code Generation._

## Using the API

To use the API, the only two steps are necessary:
1. Include the hc05 library at the beinning of your **main.c** or **main.h** file:
~~~c++
#include "hc05.h"
~~~ 
2. Initialize Bluetooth Module by **calling initializeHC05Module(&huart)**, passing as argument the UART Handler.
